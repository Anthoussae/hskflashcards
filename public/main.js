...
function curateErrorLog(){
    ...
    curatedErrorLog = curatedErrorLog + "<caption>" + "your grade: &nbsp" + letterGrade + "&nbsp"+ "&nbsp" + correctAnswers + "/" + testSize + "<br>" + "Your average grade: &nbsp" + legacyLetterGrade + "<br></br>" + "your errors: &nbsp" + "<br>" + "</caption>";
